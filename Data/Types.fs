...
module Tasks =
    ...
    type Process_IndexedEvent = 
        {   ProcessID: int option; 
            WorkflowID: int option; 
            TaskID: int option;
            eventIndex: int64; 
            eventCount: int; 
            eventContext_1: string; 
            eventContext_2: string; 
            eventContext_3: string; 
            eventContext_4: string; 
            eventCell_1: string; 
            eventCell_2: string; 
            eventCell_3: string; 
            eventCell_4: string;  
            ...
            eventTime: DateTime; 
            eventAppFile: string; 
            eventAppFrame_1: string; 
            eventAppFrame_2: string; 
            eventAppFrame_3: string; 
            eventUser: string; 
            eventLocation: string; 
            eventApplication: string; 
            eventAutomation: int; 
            eventKnowledge_1: int;
            eventKnowledge_2: int;
            eventKnowledge_3: int;
            eventComms_1: int;
            eventComms_2: int; 
            eventComms_3: int; 
            eventComms_4: int; 
            eventData_1: int;
            eventData_2: byte[];            
            events_est: string option;
            events_probs: string option;
            events_label: int option;
            Duration: float;
        }        
